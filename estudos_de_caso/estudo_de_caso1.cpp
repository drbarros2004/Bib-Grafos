...
int main() {
    ...
    string saida_arquivo = "estudo_de_caso1_vector.txt";
    string saida_arquivo_2 = "estudo_de_caso1_matriz.txt";

    vector<vector<int>> grafo1_vector = txt_to_adjacency_vector(nome_arquivo, saida_arquivo);
    ...
    BFS_tree_vector(grafo1_vector, 1, "arvoreBFS_1.txt");
    BFS_tree_vector(grafo1_vector, 2, "arvoreBFS_2.txt");
    BFS_tree_vector(grafo1_vector, 3, "arvoreBFS_3.txt");
    DFS_tree_vector(grafo1_vector, 1, "arvoreDFS_1.txt");
    DFS_tree_vector(grafo1_vector, 2, "arvoreDFS_2.txt");
    DFS_tree_vector(grafo1_vector, 3, "arvoreDFS_3.txt");

    // Distâncias e diâmetros:

    Distancia_vector(grafo1_vector, 10, 20);
    Distancia_vector(grafo1_vector, 10, 30);
    Distancia_vector(grafo1_vector, 20, 30);
    Diametro_vector(grafo1_vector);

    // Desalocar o grafo1_vector
    grafo1_vector = vector<vector<int>>();
    arquivo_de_saida.close();

    // Converte a matriz para o próximo teste
    vector<vector<bool>> grafo1_matrix = txt_to_adjacency_matrix(nome_arquivo, saida_arquivo_2);
